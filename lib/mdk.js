...
function mdkThis() {
    ...
    program
        .command('platform-generate <platform>')
        .description('Generate the given platform of the current MDK project')
        .option('-o, --offline', 'Geenrate platform using offline for maven.')
        .action(function (platformName, options) {
    ...
    program
        ...
        .description('Get the configuration value associated to the given key')
        .action(function (key) {
    ...
    program
        ...
        .description('Delete the configuration value associated to the given key' + LINE_BREAK)
        .action(function (key) {
    ...
    program
        ...
        .description('Show only the last version of MDK')
    ...
    program
        ...
        .description('Install the devtools for the given platform and MDK version')
...
// CACHE -----------------------------------------------------------------
    program
        .command('cache-clear')
        .description('Clear this tool cache'+ LINE_BREAK)
        .action(function () {
...
// USER ------------------------------------------------------------------
    ...
    program
        .command('license')
        .description('Show the Movalys MDK License'+ LINE_BREAK)
...
// GENERIC ------------------------------------------------------------------
    ...
    if (!program.args.length) {
        console.log("\n"+
            clc.xterm(208).bold("  8888ba.88ba  888888ba  dP     dP \n") +
            clc.xterm(208).bold("  88  `8b  `8b 88    `8b 88   .d8' \n") +
            clc.xterm(208).bold("  88   88   88 88     88 88aaa8P'  \n") +
            clc.xterm(208).bold("  88   88   88 88     88 88   `8b. \n") +
            clc.xterm(208).bold("  88   88   88 88    .8P 88     88 \n") +
            clc.xterm(208).bold("  dP   dP   dP 8888888P  dP     dP \n") +
            clc.redBright.bold("  oooooooooooooooooooooooooooooooo\n"));
        program.help();
    }
}
