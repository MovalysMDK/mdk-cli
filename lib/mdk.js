...
// Variables
var LINE_BREAK = '\n';
var AUTHORIZED_PLATFORM_LIST = 'android, ios';
...
function mdkQuickNotice () {
    ...
    console.log("  3. Create a new MDK project with " + clc.bold("mdk create <applicationId> -p <platforms>") + " (where platforms could be 'android', 'ios' or a comma separated list of platforms ");
