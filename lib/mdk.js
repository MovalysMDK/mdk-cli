...
function mdkThis() {
    ...
    program
        .command('infos')
        .description('In a MDK Project directory: Get information about the project.' + LINE_BREAK)
        .action(function (options) {
    ...
    program
        ...
        .description('In a MDK Project directory: Add a platform to the current MDK project.')
    ...
    program
        ...
        .description('In a MDK Project directory: Build the given platform of the current MDK project')
    ...
    program
        ...
        .description('In a MDK Project directory: Generate source code of the MDK project for the given platform')
    ...
    program
        ...
        .description('In a MDK Project directory: Display shell environment of the given platform for the current MDK project' + LINE_BREAK)
        .action(function (platformName, options) {
...
var mdkPlatformCmdFailedNotice = function(platform, projectConf) {
    console.log();
    mdkLog.separator();
    mdkLog.notice("Operation failed", "Check your environment first with command '"+ clc.bold("mdk tools-check -v " + projectConf.project.mdkVersion + " " + platform) + "'");
    mdkLog.separator();
    console.log();
};
