...
function mdkThis() {
    ...
    program
        ...
        .action(function(platformName){
            platform.runCmd("add", platformName, "Add platform " + clc.bold(platformName), function(err) {
                if ( err ) {
    ...
    program
        ...
        .action(function(platformName){
            ...
            platform.runCmd("build", platformName, "Build platform " + clc.bold(platformName), function(err) {
                if ( err ) {
    ...
    program
        ...
        .action(function(platformName){
            ...
            platform.runCmd("displayEnv", platformName, "Shell environment for platform " + clc.bold(platformName), function(err) {
                if ( err ) {
