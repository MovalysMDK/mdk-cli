...
function deployWebapp( webappDir, deployDir, conf, callback ) {
    ...
    if ( isWin ) {
        var currentDir = path.join(deployDir, conf.project.mdkVersion, conf.project.artifactId, 'current');
        ...
        var currentLnk = path.join(deployDir, conf.project.mdkVersion, conf.project.artifactId, 'current');
