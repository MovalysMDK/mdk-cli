 ...
 * @param devToolsSpecs Toolspecs of tool to uninstall
 * @param platform Platform to uninstall
 * @param osName OS Name of the system to uninstall
 * @param mdkVersion MDK Version to uninstall
 * @param removeDependencies Indicates if dependencies should be removed too
...
/**
 * Compute the list of tools to uninstall given environment parameters
 * @param devToolsSpec Toolspecs
 * @param platform The platform
 * @param osName OS Name of the current system
 * @param mdkVersion MDK version
