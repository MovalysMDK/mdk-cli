...
module.exports = {
    ...
    updateSdk: function(toolSpec, osName, callback) {
        ...
        async.waterfall([
                ...
                function(cmdObject, cb) {
                    ...
                    if (cmdObject) {
                        suppose(cmdObject.cmd + ".bat", cmdObject.params, {debug : true})
                            .when("[y/n]: ").respond("y")
                            .when("[y/n]: ").respond("y")
                            .when("[y/n]: ").respond("y")
                            .when("[y/n]: ").respond("y")
                            ...
                            .end(function(code) {
                                if (code !== 0) {
                                    ...
                                    if (cmdObject.buildToolsParams) {
                                        suppose(cmdObject.cmd + ".bat", cmdObject.buildToolsParams, {debug : true})
                                            .when("[y/n]: ").respond("y")
                                            .when("[y/n]: ").respond("y")
                                            .when("[y/n]: ").respond("y")
                                            .when("[y/n]: ").respond("y")
    ...
    getInstallCmds: function(toolSpec, osName, proxyInfo, callback) {
        ...
        // 
        var androidCmdInstallMain = path.join(toolSpec.opts.installDir, "tools", "android");
