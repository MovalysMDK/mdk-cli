...
var uninstall = require('../common/uninstall');
    ...
    check: function( toolSpec, callback ) {
        ...
        async.waterfall( [
            ...
            function (installDir, cb) {
                ...
                var gradleProperties = path.join(confDir, "gradle-template.properties");
                fs.access(gradleProperties, fs.F_OK, function(err) {
                    if (err) {
                        cb("Not installed");
                    }
                    else {
