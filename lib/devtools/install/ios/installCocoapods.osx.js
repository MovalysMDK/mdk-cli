...
var checkCocoapodsVersion = require('../../check/ios/checkCocoapodsVersion');
var checkCocoapodsFolder = require('../../check/ios/checkCocoapodsFolder');
...
module.exports = {
        ...
        async.waterfall( [
            ...
            function (installDir, cb) {
                checkCocoapodsFolder( installDir, function(err) {
                    if (err) {
                        console.log("failed to check cocoapods folder");
                        cb(err);
                    }
                    else {
                        cb(null, installDir);
    ...
    install: function( toolSpec, callback) {
        ...
        console.log("toolsSpecs : ", toolSpec);
