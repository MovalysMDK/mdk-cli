...
var checkMavenFolder = require('./maven/checkMavenFolder');
var checkMavenVersion = require('./maven/checkMavenVersion');
...
module.exports = {
    ...
    check: function( checkSpec, devToolsSpec, osName, platform, callback ) {
        ...
        async.waterfall( [
            ...
            if ( err ) {
                console.log(clc.red('[KO] ') + clc.bold(toolSpec.name) + " check failed: " + err );
                callback(false);
            }
            else {
