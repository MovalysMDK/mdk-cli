...
var checkJavaFolder = require('./checkJavaFolder');
var checkJavaVersion = require('./checkJavaVersion');
    ...
    check: function( checkSpec, devToolsSpec, osName, platform, callback ) {
        ...
        async.waterfall( [
            ...
            function (results, cb) {
                ...
                // read configuration to know where java is installed.
            ...
            if ( err ) {
                ...
                console.log(clc.green('[OK]') + " java version: " + toolSpec.version );
                callback(true);
            }
        });
    }
