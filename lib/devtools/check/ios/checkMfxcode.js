...
var checkMfxcodeFolder = require('./mfxcode/checkMfxcodeFolder');
var checkMfxcodeVersion = require('./mfxcode/checkMfxcodeVersion');
...
module.exports = {
    ...
    check: function( checkSpec, devToolsSpec, osName, platform, callback ) {
        ...
        async.waterfall( [
            function (cb) {
                // find tool spec for mfxcode
                devToolsSpecs.findToolSpec(devToolsSpec, "mfxcode", osName, platform, cb);
            },
            function (results, cb) {
            ...
            function ( toolSpec, installDir, cb) {
                // check directory of mfxcode is ok.
            ...
            function ( toolSpec, installDir, cb) {
                ...
                checkMfxcodeVersion( toolSpec.version, installDir, function(err) {
                    if (err) {
                        cb(err, toolSpec, installDir);
                    }
                    else {
