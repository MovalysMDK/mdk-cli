 ...
 * @param callback
 */
function get(mdkVersion, callback) {

    // retrieve version info
    versions.get(mdkVersion, false, function(err, versionInfo) {
        if (err) {
            callback(err);
        }
        else {
            retrieveDevToolSpec( versionInfo.devToolsVersion, false, function( err) {
