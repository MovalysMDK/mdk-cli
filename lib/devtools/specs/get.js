 ...
 * @param productDevtoolVersionFile The devtools versions file from this product
 * @param cacheDevtoolVersionFile The devtools versions file from cache
 ...
 * @param fileName The name of devtools versions file
 */
...
function loadFileFromNetwork (fileName, callback) {
    config.get('mdkUrl', function(configErr, baseUrl) {
        if (configErr) {
            ...
            network.downloadFile(options, fileName, callback);
        }
    });
}
module.exports = get;