...
function deploy( projectConf, toolSpecs, osName, callback ) {
    if (!projectConf.project.buildDisable && projectConf.deployDir && projectConf.deployDir.android ) {
        // deploy apk
        var apkFile = null;
        ...
        deployApk( apkFile, path.join(path.join(mdkpath.tmpDir,projectConf.deployDir.android), projectConf.project.mdkVersion), projectConf,
            function(err,success) {
                if ( err ) {
                    ...
                    deployScreenshots(
                        ...
                        path.join(projectConf.deployDir.android, projectConf.project.mdkVersion),
