...
function defineEnv( devToolsSpecs, osName, callback ) {
    ...
    async.waterfall([
        function(cb) {
            jdk.defineEnv(devToolsSpecs, osName, "android", cb);
        },
        function(cb) {
            maven.defineEnv(devToolsSpecs, osName, "android", cb);
        },
        function(cb) {
            gradle.defineEnv(devToolsSpecs, osName, "android", cb);
        },
        function(cb) {
            sdk.defineEnv(devToolsSpecs, osName, "android", cb);
        }
    ],
    function(err) {
        callback(err);
